...
public class Staff implements ActionListener{
    ...
    public Staff(){
        ...
        mn.setValueAt("978-31-2573830-0", line, 1);
        mn.setValueAt("A BOUT A BOY", line, 2);
        mn.setValueAt("Nick Hornby", line, 3);
        mn.setValueAt("Novel", line, 4);
        mn.setValueAt("2", line, 5);
        line = line + 1;
            ...
            public void actionPerformed(ActionEvent e) {
             ...
             insert.addActionListener(new ActionListener(){
                 ...
                 public void actionPerformed(ActionEvent ex){
                     ...
                     mn.setValueAt(newpanel.getAuthorField().getText(), line, 3);
                     mn.setValueAt(newpanel.getGenre().getSelectedItem().toString(), line, 4);
                     mn.setValueAt(Integer.parseInt(newpanel.getAmount().getText()), line, 5);
                     line = line + 1;
        ...
        @Override
            public void actionPerformed(ActionEvent e) {
                try{
                        ...
                        mn.removeRow(managetable.getSelectedRow());
                }catch(Exception ex){
